...
if os.path.isfile('./checkpoints/AoA_model.pt'):
    model.load_state_dict(torch.load('./checkpoints/AoA_model.pt'))
...
for epoch in range(N_EPOCHS):
    ...
    if train_loss < best_epoch_loss:
        ...
        torch.save(model.state_dict(), './checkpoints/AoA_model.pt')
...
trained_model.load_state_dict(torch.load('./checkpoints/AoA_model.pt'))
